                    ...
                    <Col md={8}>
                                ...
                                <Tabs defaultActiveKey="my-task" className="p-20">
                                    ...
                                    <Tab eventKey="my-project" title="My Projects">
                                        ...
                                        <div className="text-right m-r-20">
                                            <Link to='#' className=" b-b-primary text-primary">View all Projects</Link>
                                        </div>
                                    </Tab>
                        ...
                        <Card className="table-card review-card">
                            ...
                            <Card.Body>
                                <div className="review-block">
                                    <div className="row">
                                        ...
                                        <div className="col">
                                            ...
                                            <Link to='#'><i className="feather icon-star-on f-18 text-c-yellow"/></Link>
                                            <Link to='#'><i className="feather icon-star-on f-18 text-c-yellow"/></Link>
                                            <Link to='#'><i className="feather icon-star-on f-18 text-c-yellow"/></Link>
                                            <Link to='#'><i className="feather icon-star f-18 text-muted"/></Link>
                                            <Link to='#'><i className="feather icon-star f-18 text-muted"/></Link>
                                            ...
                                            <Link to='#' className="m-r-30 text-muted"><i className="feather icon-thumbs-up m-r-15"/>Helpful?</Link>
                                            <Link to='#'><i className="feather icon-heart-on text-c-red m-r-15"/></Link>
                                            <Link to='#'><i className="feather icon-edit text-muted"/></Link>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="col-sm-auto p-r-0">
                                ...
                                <div className="text-right  m-r-20">
                                    <Link to='#' className="b-b-primary text-primary">View all Customer Reviews</Link>
                                </div>
                            </Card.Body>
                        </Card>
                    </Col>
                            ...
                            <Card.Body>
                                <ul className="list-unstyled task-list">
                                    <li>
                                        ...
                                        <h6 className="text-muted">Call to customer <span className="text-c-blue"> <Link to='#' className="text-c-blue">Jacob</Link> </span> and discuss the</h6>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <h6 className="text-muted"><span className="text-c-blue"><Link to='#' className="text-c-blue">Jeny</Link></span> assign you a task <span className="text-c-blue"><Link to='#' className="text-c-blue">Mockup Design.</Link></span></h6>
                                    </li>
                                    <li>
