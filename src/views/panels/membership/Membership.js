        ...
        <React.Fragment>
            <Row className='justify-content-center'>
                        ...
                        <Card>
                            <Card.Body className="text-center">
                                <img src={medalTrial} alt="" className="img-fluid w-50"/>
                                    ...
                                    <hr/>
                                    <button type="button" className="btn btn-icon btn-outline-primary mr-2" onClick={() => setIsOpen(true)}><i className="feather icon-edit-2"/></button>
                    ...
                    <Col sm={12} className='text-center'>
                        <Button variant='primary' type="button" onClick={() => setIsOpen(true)}><i className="feather icon-plus"/>New Membership</Button>
                    </Col>
                </Row>
