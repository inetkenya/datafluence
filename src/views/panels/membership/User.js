                            ...
                            <Card.Body className="text-center">
                                <Row className="align-items-center m-l-0">
                                    ...
                                    <Col className="text-right">
                                        <button type="button" className="btn btn-primary btn-sm" onClick={() => setIsOpen(true)}><i className="feather icon-plus"/>New User</button>
                                    </Col>
                                </Row>
                                <ul className="list-inline">
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> Sorting Options </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 font-weight-bolder"> Reset </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> Membership </Link></li>
                                    <li className="list-inline-item"><Link to='#' className="text-muted pl-2"> Username </Link></li>
                                </ul>
                                <ul className="list-inline mb-0">
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> A </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> B </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> C </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> D </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> E </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> F </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> G </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> H </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> I </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> J </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> K </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> L </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> M </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> N </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> O </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> P </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> Q </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> R </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> S </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> T </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> U </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> V </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> W </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> X </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> Y </Link></li>
                                    <li className="list-inline-item border-right m-0"><Link to='#' className="pr-2 pl-2 text-muted"> Z </Link></li>
                                    <li className="list-inline-item"><Link to='#' className="font-weight-bolder pl-2"> All </Link></li>
                                </ul>
                            </Card.Body>
                        </Card>
                    </Col>
                                        ...
                                        <Col className="text-right pb-3">
                                            <Dropdown className="dropdown">
                                                ...
                                                <Dropdown.Menu className="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <Link to='#' className="dropdown-item">Trash</Link>
                                                </Dropdown.Menu>
                                            </Dropdown>
                                        </Col>
                                    </Row>
