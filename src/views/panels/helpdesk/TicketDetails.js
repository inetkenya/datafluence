                                ...
                                <Row className="align-items-center">
                                    ...
                                    <Col md={4}>
                                        <div className="btn-star">
                                            <Link to='#' className="btn waves-effect waves-light btn-primary btn-sm mr-1">Mark as unread</Link>
                                            <Link to='#'><i className="feather icon-star f-20 text-muted"/></Link>
                                        </div>
                                    </Col>
                                </Row>
                            </Card.Body>
                                    ...
                                    <Col sm='auto' className="pl-0 col-right">
                                        <Card.Body className="text-center">
                                            <ul className="list-unstyled mb-0 edit-del">
                                                <li className="d-inline-block f-20 mr-1"><Link to='#'><i className="feather icon-edit-2 text-muted"/></Link></li>
                                                <li className="d-inline-block f-20"><Link to='#'><i className="feather icon-trash-2 text-muted"/></Link></li>
                                            </ul>
                                        </Card.Body>
                                    </Col>
                                </Row>
                                ...
                                <li className="list-group-item">
                                    <div className="media align-items-center">
                                        ...
                                        <div className="media-body">
                                            <p className="mb-0"><img src={avatar5} alt="" className="wid-20 rounded mr-1 img-fluid"/><Link to='#'>Jack Pall</Link></p>
                                        </div>
                                    </div>
                                </li>
                                <li className="list-group-item">
                                    <div className="media align-items-center">
                                        ...
                                        <div className="media-body">
                                            <p className="mb-0"><i className="feather icon-mail mr-1"/><Link to='#'>mail@mail.com</Link></p>
                                        </div>
                                    </div>
                                </li>
                                <li className="list-group-item">
                                    <div className="media align-items-center">
                                        ...
                                        <div className="media-body">
                                            <p className="mb-0"><img src={p1} alt="" className="wid-20 rounded mr-1 img-fluid"/><Link to='#'>Alpha pro</Link></p>
                                        </div>
                                    </div>
                                </li>
                                <li className="list-group-item">
                                    <div className="media align-items-center">
                                        ...
                                        <div className="media-body">
                                            <p className="mb-0"><img src={avatar4} alt="" className="wid-20 rounded mr-1 img-fluid"/><Link to='#'>Lina Hop</Link></p>
                                        </div>
                                    </div>
                                </li>
                                <li className="list-group-item">
