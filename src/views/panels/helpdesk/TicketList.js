                                            ...
                                            <div className="col border-right pr-0">
                                                <div className="card-body inner-center">
                                                    ...
                                                    <div className="excerpt mt-4">
                                                        <h6><img src={avatar5} alt="" className="wid-20 avatar mr-2 rounded"/>Last comment from <Link to='#'>Robert alia:</Link></h6>
                                                    ...
                                                    <div className="mt-2">
                                                        <Link to='#' className="mr-3 text-muted"><i className="feather icon-eye mr-1"/>View Ticket</Link>
                                                        <Link to='#' className="text-danger"><i className="feather icon-trash-2 mr-1"/>Delete</Link>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-auto pl-0 right-icon">
                                                <div className="card-body">
                                                    <ul className="list-unstyled mb-0">
                                                        <li><Link to='#' data-toggle="tooltip" data-placement="top" title="" data-original-title="tooltip on top" className="active"><i className="feather icon-star text-warning"/></Link></li>
                                                        <li><Link to='#' data-toggle="tooltip" data-placement="top" title="" data-original-title="tooltip on top"><i className="feather icon-circle text-muted"/></Link></li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div className="cat-list">
                                        <div className="border-bottom pb-3 ">
                                            ...
                                            <div className="float-right span-content">
                                                <Link to='#' className="btn waves-effect waves-light btn-default badge-danger rounded-circle mr-1" data-toggle="tooltip" data-placement="top" title="" data-original-title="tooltip on top">1</Link>
                                                <Link to='#' className="btn waves-effect waves-light btn-default badge-secondary rounded-circle mr-0 " data-toggle="tooltip" data-placement="top" title="" data-original-title="tooltip on top">3</Link>
                                            </div>
                                        </div>
                        ...
                        <Col sm={12}>
                            <Card className='border-0 shadow-none'>
                                            ...
                                            <div className="btn-block mt-3">
                                                <Dropdown className="btn-group mb-2 mr-2">
                                                    ...
                                                    <Dropdown.Menu className="dropdown-menu">
                                                        <Link className="dropdown-item" as={Link} to='#'>Action</Link>
                                                        <Link className="dropdown-item" as={Link} to='#'>Another action</Link>
                                                        <Link className="dropdown-item" as={Link} to='#'>Something else here</Link>
                                                        <div className="dropdown-divider"/>
                                                        <Link className="dropdown-item" as={Link} to='#'>Separated link</Link>
                                                    </Dropdown.Menu>
                                                </Dropdown>
                                ...
                                <Row className="border-bottom border-top pb-3 pt-4 pl-3 pr-3">
                                    ...
                                    <Col sm='auto'>
                                        <ul className="list-unstyled mb-0">
                                            <li className="d-inline-block mr-1"><Link to='#'><i className="feather icon-edit text-muted"/></Link></li>
                                            <li className="d-inline-block"><Link to='#'><i className="feather icon-trash-2 text-muted"/></Link></li>
                                        </ul>
                                    </Col>
