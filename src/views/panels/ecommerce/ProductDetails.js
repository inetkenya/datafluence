                            ...
                            <Row>
                                ...
                                <Col lg={7}>
                                    <div className="pl-lg-4">
                                        ...
                                        <h3 className="mt-0">Women Purple Sling Bag <Link to='#' className="text-muted"><i className="mdi mdi-square-edit-outline ml-2"/></Link> </h3>
                                ...
                                <Col lg={12}>
                                    <div className="mt-4">
                                        ...
                                        <h6><Link to='#'>Manufacturing, Packaging and Import Info</Link></h6>
                                    </div>
                                </Col>
                            </Row>
